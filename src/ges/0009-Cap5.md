...
- {orange}(**Taxa de juro nominal (jn)**): Usa-se em avaliação de projetos a preços constantes, não é corrigida tendo em conta o efeito da inflação.
